				...
				<section class="content">
					<div class="box box-tgsc collapsed-box">
						<div class="box-header with-border" data-widget="collapse" style="cursor: pointer;">
							<h3 class="box-title">Add Project Detail</h3>
							<div class="box-tools pull-right">
								<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>								
							</div>
						</div>
						<form ng-submit="addProjectDetail()">
							<div class="box-body">
								<div class="row">
									<div class="col-md-3">
									...
									<!-- <div class="col-md-3">
										<div class="form-group">
											<label>Payment Schedule<font color="red" size="3">*</font></label>
											<input type="text" id="paymentscheduleadd" name="paymentscheduleadd" ng-model="paymentscheduleadd" class="form-control">
											<p ng-show="errorPaymentSchedule == 1" style="color: red;">{{msgPaymentSchedule}}</p>										
										</div>									
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label>Payment Percentage(%)<font color="red" size="3">*</font></label>
											<input type="text" id="paymentpercentageadd" name="paymentpercentageadd" ng-model="paymentpercentageadd" class="form-control">
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													<div class="row">
														...
														<div class="col-md-3">
															<div class="form-group">
																<input type="text" id="towernameadd" name="towernameadd" ng-model="towernameadd" placeholder="Tower Name" class="form-control" ng-change="setFlag()">
																<p ng-show="errorAreaV == 1" style="color: red;">{{msgAreaV}}</p>
															</div>
														</div>														
														<div class="col-md-3">
															<div class="form-group">
																<input type="text" id="BHKadd" name="BHKadd" ng-model="BHKadd" placeholder="BHK" class="form-control">
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<input type="text" id="unitsadd" name="unitsadd" ng-model="unitsadd" placeholder="No Of Units" class="form-control">
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<input type="text" id="buildupadd" name="buildupadd" ng-model="buildupadd" placeholder="Build up area" class="form-control">
															</div>
														</div>
													</div>
													<div class="row">	
														<div class="col-md-3">
															<div class="form-group">
																<input type="text" id="sbuildupadd" name="sbuildupadd" ng-model="sbuildupadd" placeholder="S. Build up area" class="form-control">
															</div>
														</div>
														<div class="col-md-3">
															<div class="form-group">
																<input type="text" id="terraceadd" name="terraceadd" ng-model="terraceadd" placeholder="Terrace area" class="form-control">
															</div>
														</div>
														<div class="col-md-1">
															<div class="form-group">
								...
								<table class="table no-margin">
									...
									<tbody>
										...
										<tr ng-repeat="item in getPayment" style="cursor:pointer;cursor:hand">
											<td ng-click="getPayments(item.paymentId)" title="Edit Record" data-toggle="modal" data-target="#editModal">{{item.paymentLabel}}</td>
					...
					<form ng-submit="editPayment(paymentid)">
						<div class="modal-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label>Payment Label<font color="red" size="3">*</font></label>
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Payment Schedule<font color="red" size="3">*</font></label>
										<input type="text" id="paymentscheduleedit" name="paymentscheduleedit" ng-model="paymentscheduleedit" class="form-control">
										<p ng-show="errorPaymentSchedule == 1" style="color: red;">{{msgPaymentSchedule}}</p>										
									</div>									
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label>Payment Percentage(%)<font color="red" size="3">*</font></label>
										<input type="text" id="paymentpercentageedit" name="paymentpercentageedit" ng-model="paymentpercentageedit" class="form-control">
										<p ng-show="errorPaymentPercentage == 1" style="color: red;">{{msgPaymentPercen}}</p>										
									</div>									
								</div>
							</div>
