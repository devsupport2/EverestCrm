							...
							<div class="box-body">
								...
								<div class="row">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label>Floor</label>
											<select class="form-control" id="floor" name="floor" ng-model="floor" ng-options="item for item in floors">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="number" id="propertytitle" name="propertytitle" ng-model="propertytitle" placeholder="Property Number" class="form-control" ng-change="setFlag()">
								...
								<div class="row">
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											<select id="propertystatusadd" name="propertystatusadd" ng-model="propertystatusadd" class="form-control" ng-change="setFlag()" ng-init="propertystatusadd ='Available'">
								...
								<div class="row">																		
									<div class="col-md-12">
										<div class="panel-group">
											<div class="panel panel-default">
												<div class="panel-heading">
													 <h4 class="panel-title"><i class="fa fa-file-o" aria-hidden="true"></i>&nbsp;Property Layout</h4>
												</div>
												<div class="panel-body">
													<div class="row">
														<div class="col-md-4">
															<div class="form-group">
																<input type="text" id="layouttitleadd" name="layouttitleadd" ng-model="layouttitleadd" placeholder="Title" class="form-control" ng-change="setFlag()">
																<p ng-show="errorLayoutTitle == 1" style="color: red;">{{msgLayoutTitle}}</p>
															</div>
														</div>
														<div class="col-md-4">
															<div class="form-group">
																<input type="file" id="layoutimageadd" name="layoutimageadd" class="form-control" ng-change="setFlag()">
																<p ng-show="errorLayoutImage == 1" style="color: red;">{{msgLayoutImage}}</p>
															</div>
														</div>																												
														<div class="col-md-1">
															<div class="form-group">
																<button ng-disabled="spin == 1" ng-click="addLayoutRow()" class="btn btn-primary btn-sm" title="Add Specification"><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i><span  ng-if="spin != 1" class="fa fa-plus"></span></button>
															</div>
														</div>
													</div>																									
													<div class="table-responsive table-bordered">
														<table class="table">
															...
															<tbody>
																<tr ng-repeat="item in propertyLayout">
																	<td> {{item.layoutTitle}} </td>
																	<td><i class="fa fa-file-image-o" aria-hidden="true"></i></td>
																	<td>
																		<a href="#" ng-click="removeLayoutRow(item)" class="delete" data-toggle="modal">
																			<i class="fa fa-trash" aria-hidden="true" data-toggle="tooltip" title="Delete"></i>
																		</a>
																	</td>
																</tr>
					...
					<div class="box box-tgsc">
						<div class="box-header with-border">
							<div class="row">
								...
								<div class="col-md-2" ng-show="projectid !=null">
									<div class="form-group">
										<select id="pcategoryid" name="pcategoryid" ng-model="pcategoryid" class="form-control" ng-change="setFlag()">
											<option value="">Category</option>
											<option ng-repeat="item in projectRealestateCategory  | unique:'categoryId'" value="{{item.categoryTitle}}">{{item.categoryTitle}}</option>
										</select>
									</div>
								</div>
								<div class="col-md-2" ng-show="projectid !=null">
									<div class="form-group">
										<select ng-model="subcategory" id="subcategory" title="Filter by subcategory" class="form-control">
											<option value="">Subcategory</option>
							...
							<div class="table-responsive">
								<table class="table no-margin">
									<thead>
										<tr>
											<th>Unit Name</th>
											<th>Floor - <span title="Property Number">P Number</span></th>
											<th>Project Title</th>
											<th>Category</th>
											<th>Sub-category</th>
											<th>Type of Realestate</th>
											<th><span title="Property Status">P Status</span> </th>
											<th>Clone </th>
									...
									<tbody>
										...
										<tr ng-repeat="item in getProperty | filter:pcategoryid | filter:subcategory" style="cursor:pointer;cursor:hand" ng-style="(item.propertyStatus == 'Booked') && {'background-color':'#008000ad'} || (item.propertyStatus == 'Blocked') && {'background-color':'#ff00007a'}">
											...
											<td ng-click="getPropertyDetails(item.propertyId)" title="Edit Record" data-toggle="modal" data-target="#editModal">{{item.floor}} - {{item.propertyTitle}}</td>
											...
											<td ng-click="getPropertyDetails(item.propertyId)" title="Edit Record" data-toggle="modal" data-target="#editModal">{{item.propertyStatus}}</td>
						...
						<div class="box-body">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<select class="form-control" id="flooredit" name="flooredit" ng-model="flooredit">
											<option value=""> Floor </option>
											<option ng-repeat="item in floors" value="{{item}}">{{item}}</option>									
										</select>											
									</div>
								</div>
								<div class="col-md-3">
							...
							<div class="row">																			
								...
								<div class="col-md-3">
									<label>Property Status</label>
									<div class="form-group">
										<select id="propertystatus" name="propertystatus" ng-model="propertystatus" class="form-control" ng-change="setFlag()">
											<option value="Available">Available</option>
											<option value="Booked">Booked</option>
											<option value="Blocked">Blocked</option>																																		
										</select>																					
											...
											<div class="panel panel-default">
												...
												<div class="panel-body">
													<div class="row">
														<div class="col-md-4">
															<div class="form-group">
																<input type="text" id="layouttitleedit" name="layouttitleedit" ng-model="layouttitleedit" placeholder="Title" class="form-control" ng-change="setFlag()">
																<p ng-show="errorLayoutTitle == 1" style="color: red;">{{msgLayoutTitle}}</p>
															</div>
														</div>
														<div class="col-md-4">
															<div class="form-group">
																<input type="file" id="layoutimageedit" name="layoutimageedit" class="form-control" ng-change="setFlag()">
																<p ng-show="errorLayoutImage == 1" style="color: red;">{{msgLayoutImage}}</p>
															</div>
														</div>																												
														<div class="col-md-1">
															<div class="form-group">
																<button ng-disabled="spin == 1" ng-click="editLayoutRow()" class="btn btn-primary btn-sm" title="Add Layout"><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i><span  ng-if="spin != 1" class="fa fa-plus"></span></button>
															</div>
														</div>
													</div>																									
													<div class="table-responsive table-bordered">
														<table class="table">
															...
															<tbody>
																<tr ng-repeat="item in propertyLayout">
																	<td> {{item.layoutTitle}} </td>
																	<td><a href="{{item.image}}" target="_blank"><i class="fa fa-file-image-o" aria-hidden="true"></i></a></td>
																	<td>
																		<a href="#" ng-click="removeLayoutRowEdit(item.propertyLayoutId)" class="delete" data-toggle="modal">
																			<i class="fa fa-trash" aria-hidden="true" data-toggle="tooltip" title="Delete"></i>
																		</a>
																	</td>
																</tr>
