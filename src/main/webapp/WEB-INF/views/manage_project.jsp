					...
					<div class="box box-tgsc collapsed-box">
						...
						<div class="box-body">
							...
							<div class="row">
								<div class="col-md-3">
								<div class="form-group">
								<label>Show on Website<font color="red" size="3">*</font></label>
								<select id="shown_project" name="shown_project" ng-model="shown_project" class="form-control" >
							...
							<div class="row">																		
								<div class="col-md-12">
									<div class="panel-group">
										<div class="panel panel-default">
											<div class="panel-heading">
												 <h4 class="panel-title"><i class="fa fa-file-o" aria-hidden="true"></i>&nbsp;Approved Banks</h4>
											</div>
											<div class="panel-body">
												<div class="row ">
													<div class="col-md-3">
														<div class="form-group">																
															<select id="bankadd" name="bankadd" ng-model="bankadd" class="form-control" ng-change="setFlag()">
																<option value="">Bank</option>
																<option ng-repeat="item in getBank" value="{{item.bankId}}">{{item.bankName}}</option>											
															</select>
															<p ng-show="errorBank == 1" style="color: red;">{{msgBank}}</p>																										
														</div>									
													</div>																											
													<div class="col-md-1">
														<div class="form-group">
															<button ng-disabled="spin == 1" ng-click="addBankRow()" class="btn btn-primary btn-sm" title="Add Property Types"><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i><span  ng-if="spin != 1" class="fa fa-plus"></span></button>
														</div>
													</div>
												</div>																																						
												<div class="table-responsive table-bordered">
													<table class="table">
														...
														<tbody>
															<tr ng-repeat="item in banklist">
																...
																<td>
																	<a href="#" ng-click="removeBankRow(item)" class="delete" data-toggle="modal">
																		<i class="fa fa-trash" aria-hidden="true" data-toggle="tooltip" title="Delete"></i>
																	</a>
																</td>
															</tr>
					...
					<!-- <form> -->
						<div class="modal-body">
							...
							<div class="row">
								...
								<div class="form-group">
								<label>Show on Website<font color="red" size="3">*</font></label>
								<select id="shown_project" name="shown_project" ng-model="shown_project1" class="form-control" >
										 <option value="" selected>Select Option </option> 
											<option value="y">Yes</option>
											<option value="n">No</option>
										</select>
										...
										<div class="panel panel-default">
											...
											<div class="panel-body">
												<div class="row ">
													<div class="col-md-3">
														<div class="form-group">																
															<select id="bankedit" name="bankedit" ng-model="bankedit" class="form-control" ng-change="setFlag()">
																<option value="">Bank</option>
																<option ng-repeat="item in getBank" value="{{item.bankId}}">{{item.bankName}}</option>											
															</select>
															<p ng-show="errorBank == 1" style="color: red;">{{msgBank}}</p>																										
													...
													<div class="col-md-1">
														<div class="form-group">
															<button ng-disabled="spin == 1" ng-click="editBankRow()" class="btn btn-primary btn-sm" title="Add Property Types"><i class="fa fa-refresh fa-spin" ng-if="spin == 1"></i><span  ng-if="spin != 1" class="fa fa-plus"></span></button>
														</div>
													</div>
												</div>																																						
												<div class="table-responsive table-bordered">
													<table class="table">
														...
														<tbody>
															<tr ng-repeat="item in bankById">
																<td> {{item.title}} </td>
																<td>
																	<a href="#" ng-click="removeBankRowEdit(item.projectBankId)" class="delete" data-toggle="modal">
																		<i class="fa fa-trash" aria-hidden="true" data-toggle="tooltip" title="Delete"></i>
																	</a>
																</td>
															</tr>
