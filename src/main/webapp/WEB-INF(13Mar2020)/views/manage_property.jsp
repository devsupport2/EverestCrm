							...
							<div class="table-responsive">
								<table class="table no-margin">
									...
									<tbody>
										...
										<tr ng-repeat="item in getProperty | filter:pcategoryid | filter:subcategory" style="cursor:pointer;cursor:hand">
						...
						<div class="box-body">
							...
							<div class="row">							
								...
								<div class="col-md-3">
									<div class="form-group">
										<label>Property Number<font color="red" size="3">*</font></label>
										<input type="number" id="propertytitleedit" name="propertytitleedit" ng-model="propertytitleedit" placeholder="Property Number" class="form-control" ng-change="setFlag()">
										<p ng-show="errorUnits == 1" style="color: red;">{{msgUnits}}</p>											
									</div>
								</div>
								<div class="col-md-3">
